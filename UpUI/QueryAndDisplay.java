...
public class QueryAndDisplay {
    ...
    private JButton button1; // 添加按钮 1
    private JButton button2; // 添加按钮 2
    private JButton button3; // 添加按钮 3

    public QueryAndDisplay() {
        daan = new ArrayList<>();
    ...
    public void displayQuestionsFromDatabase() throws ClassNotFoundException {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password)) {
            ...
            button1 = new JButton("跳转到标题 1"); // 创建按钮 1
            button1.addActionListener(e -> {
                // 实现跳转到标题 1 的逻辑
            });
            frame.add(button1);

            button2 = new JButton("跳转到标题 2"); // 创建按钮 2
            button2.addActionListener(e -> {
                // 实现跳转到标题 2 的逻辑
            });
            frame.add(button2);

            button3 = new JButton("跳转到标题 3"); // 创建按钮 3
